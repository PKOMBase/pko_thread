...
public class PhaserDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("register, thread:" + Thread.currentThread().getName() + ", register:" + register);
        ...
        System.out.println("arriveAndDeregister, thread:" + Thread.currentThread().getName() + ", arriveAndDeregister:"
                + arriveAndDeregister);
